...
<input type="hidden" id="index" value="${file.index}" />
		...
		<div class="col">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="writer"
					placeholder="작성자" value="${file.writer}">
			</div>
		</div>
...
<form method="post" class="contentcontainer" action="modified.do"
	id="fileForm">
	<textarea name="editordata" id="summernote">${file.contents}</textarea>
